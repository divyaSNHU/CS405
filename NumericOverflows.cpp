...
{
    T result = start;
    //Test each Iteration for each INT type for additional Increment and max() is specific for each data type 
    //Return -1 overflow occurs
...
void test_overflow()
{
    ...
    if (result == -1) {                                 
        std::cout <<"OVERFLOW ERROR"<< std::endl        //if overflow occurs print overflow error message
    }
    else {
        std::cout << +result << std::endl;              //else print results
    }
}
...
void test_underflow()
{
    ...
    if(result == -1) {                                 
        std::cout <<"UNDERFLOW ERROR"<< std::endl        //if underflow occurs print underflow error message
    }
    else {
        std::cout << +result << std::endl;              //else print results
    }
